...
In this project, we looked at Euro Cup 2016 data and write queries to answer the following questions.
...
Individual SQL script for solution to each question (SQL file naming convention is sql_q<question number>_sol.sql e.g.- sql_q1_sol.sql, sql_q2_sol.sql, etc.)
